...
namespace TryMLNET
{
    ...
    {
        public const string RetrainConnectionString = @"Data Source=MAINFRAME-007;Initial Catalog=Northwind;Integrated Security=True;Encrypt=False";
        public const string RetrainCommandString = @"SELECT [MonthlySales], CAST([CustomerID] as NVARCHAR(MAX)), CAST([SaleAmount] as REAL) FROM [dbo].[vwMonthly_Sales_by_Customer]";
