...
namespace Models
{
	...
	public partial class NorthwindDb : LinqToDB.Data.DataConnection
	{
		...
		public ITable<VwMonthlySalesByCustomer>   VwMonthlySalesByCustomers    { get { return this.GetTable<VwMonthlySalesByCustomer>(); } }
		...
		public NorthwindDb(DataOptions options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
	...
	[Table(Schema="dbo", Name="vwMonthly_Sales_by_Customer", IsView=true)]
	public partial class VwMonthlySalesByCustomer
	{
		[Column, Nullable] public DateTime? MonthlySales { get; set; } // date
		[Column, Nullable] public string    CustomerID   { get; set; } // nchar(5)
		[Column, Nullable] public double?   SaleAmount   { get; set; } // float
	}
	...
	public static partial class NorthwindDbStoredProcedures
	{
		...
		public static IEnumerable<EmployeeSalesByCountryResult> EmployeeSalesByCountry(this NorthwindDb dataConnection, DateTime? @BeginningDate, DateTime? @EndingDate)
		{
			var parameters = new []
			{
		...
		public static IEnumerable<SalesByYearResult> SalesByYear(this NorthwindDb dataConnection, DateTime? @BeginningDate, DateTime? @EndingDate)
		{
			var parameters = new []
			{
				new DataParameter("@Beginning_Date", @BeginningDate, LinqToDB.DataType.DateTime),
		...
		public static int SpAlterdiagram(this NorthwindDb dataConnection, string @diagramname, int? @ownerId, int? @version, byte[] @definition)
		{
			var parameters = new []
			{
		...
		public static int SpCreatediagram(this NorthwindDb dataConnection, string @diagramname, int? @ownerId, int? @version, byte[] @definition)
		{
			var parameters = new []
			{
				new DataParameter("@diagramname", @diagramname, LinqToDB.DataType.NVarChar)
		...
		public static int SpDropdiagram(this NorthwindDb dataConnection, string @diagramname, int? @ownerId)
		{
			var parameters = new []
			{
				new DataParameter("@diagramname", @diagramname, LinqToDB.DataType.NVarChar)
		...
		public static IEnumerable<SpHelpdiagramdefinitionResult> SpHelpdiagramdefinition(this NorthwindDb dataConnection, string @diagramname, int? @ownerId)
		{
			var parameters = new []
			{
				new DataParameter("@diagramname", @diagramname, LinqToDB.DataType.NVarChar)
		...
		public static IEnumerable<SpHelpdiagramsResult> SpHelpdiagrams(this NorthwindDb dataConnection, string @diagramname, int? @ownerId)
		{
			var parameters = new []
			{
				new DataParameter("@diagramname", @diagramname, LinqToDB.DataType.NVarChar)
		...
		public static int SpRenamediagram(this NorthwindDb dataConnection, string @diagramname, int? @ownerId, string @newDiagramname)
		{
			var parameters = new []
			{
				new DataParameter("@diagramname",     @diagramname,    LinqToDB.DataType.NVarChar)
		...
		public static int SpUpgraddiagrams(this NorthwindDb dataConnection)
		{
